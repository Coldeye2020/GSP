...
class PNA(torch.nn.Module):
    def __init__(self, x_dim, edge_attr_dim, num_class, multi_label, model_config, node_encoder):
        super().__init__()
        hidden_size = model_config['hidden_size'] if not node_encoder else model_config['prompt_hidden_size']
        self.n_layers = model_config['n_layers'] if not node_encoder else model_config['node_n_layers']
